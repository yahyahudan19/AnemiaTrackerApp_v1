...
//Admin Routes
Route::get('/dashboard','\App\Http\Controllers\AdminController@index')->name('index'); //Dashboard Admin Views
...
Route::post('/auth','\App\Http\Controllers\AuthController@login'); // Login Process
